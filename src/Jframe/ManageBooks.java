...
public class ManageBooks extends javax.swing.JFrame {
    ...
    public static void addBook(){
        ...
        String authorname = txt_author.getText();
        String quantityy;
        quantityy = txt_quantity.getText();
        
 
        try{
          DBConnection.insertData("insert into book_details(book_id,book_name,author_name,quantity)"
                  +"Values('"+ bookid+"','"+ bookname+"','"+ authorname+"','"+ quantityy+"')" );
     ...
     public void  UpdateBook() throws Exception{
        ...
        int quantityy = Integer.parseInt(txt_quantity.getText());
        String bookname = txt_bookName.getText();
        String authorname = txt_author.getText();
         ...
         try {
              ...
              con = DriverManager.getConnection("jdbc:mysql://localhost:3306/library_ms","root","arkani987794");
               ...
               PreparedStatement ps = con.prepareStatement("UPDATE book_details SET  book_id=?, book_name=?, author_name=?, quantity=?  WHERE book_id='"+bookid+"'");
                ps.setInt(1, bookid);
                ps.setString(2, bookname);
                ps.setString(3, authorname);
                ps.setInt(4, quantityy);
     ...
     public static void deleteData(){
       ...
       int bookid = Integer.parseInt(txt_bookid.getText());
        ...
        try{
          DBConnection.insertData(" Delete from book_details where book_id = '"+bookid+"' ");
    ...
    private void initComponents() {
        ...
        rSMaterialButtonCircle3.setBackground(new java.awt.Color(102, 255, 0));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(6, 6, 6)
                                .addComponent(txt_author, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(6, 6, 6)
                                .addComponent(txt_quantity, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txt_bookName, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel9)
                            .addComponent(jLabel10)
                            .addComponent(txt_bookid, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(48, 48, 48))
        );
        ...
        tbl_bookDetails.setColorBordeFilas(new java.awt.Color(102, 102, 225));
    ...
    private void tbl_bookDetailsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_bookDetailsMouseClicked
        ...
        TableModel modell = tbl_bookDetails.getModel();
        
        txt_bookid.setText(modell.getValueAt(rowNo, 0).toString());
        txt_bookName.setText(modell.getValueAt(rowNo, 1).toString());
        txt_author.setText(modell.getValueAt(rowNo, 2).toString());
        txt_quantity.setText(modell.getValueAt(rowNo, 3).toString());
    ...
    private static javax.swing.JTextField txt_bookName;
    private static javax.swing.JTextField txt_bookid;
    private static javax.swing.JTextField txt_quantity;
