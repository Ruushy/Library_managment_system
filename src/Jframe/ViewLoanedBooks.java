 ...
 * @author thali
 */
public class ViewLoanedBooks extends javax.swing.JFrame {

    /**
     * Creates new form ViewLoanedBooks
     */
    ...
    public void setTableBookDetails(){
        try {
            ...
            ResultSet rs = st.executeQuery("select * from loan_books where status = 'pending'");
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Loaned Books list");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewLoanedBooks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewLoanedBooks().setVisible(true);
            }
        });
    }
